    ...
    if (isset($_POST['signup'])) {
        ...
        if (empty($firstname)) {
            ...
            try {
                ...
                $check_email = $conn->prepare("SELECT email FROM db_prousers WHERE email = :email");
                ...
                if ($row['email'] == $email) {
                    ...
                    $stmt = $conn->prepare("INSERT INTO db_prousers(firstname, lastname, email, password, urole) 
